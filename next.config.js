...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		NEXT_PUBLIC_ARRANGER_CLINICAL_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_CLINICAL_DOCUMENT_TYPE,
		...
		NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_ADMIN_UI: process.env.NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_ADMIN_UI_URL,
		NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_API: process.env.NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_API_URL,
		NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_DOCUMENT_TYPE: process.env.NEXT_PUBLIC_ARRANGER_ENVIRONMENTAL_DOCUMENT_TYPE,
		...
		NEXT_PUBLIC_ENVIRONMENTAL_SUBMISSION_API_URL: process.env.NEXT_PUBLIC_ENVIRONMENTAL_SUBMISSION_API_URL,
		NEXT_PUBLIC_ENVIRONMENTAL_SUBMISSION_CATEGORY_ID: process.env.NEXT_PUBLIC_ENVIRONMENTAL_SUBMISSION_CATEGORY_ID,
		NEXT_PUBLIC_ENVIRONMENTAL_SAMPLE_ID_FIELD_NAME: process.env.NEXT_PUBLIC_ENVIRONMENTAL_SAMPLE_ID_FIELD_NAME,
		...
		NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_ADMIN_WRITE: process.env.NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_ADMIN_WRITE,
		NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_PREFIX_WRITE: process.env.NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_PREFIX_WRITE,
		NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_SUFFIX_WRITE: process.env.NEXT_PUBLIC_SCOPE_ENVIRONMENTAL_SUFFIX_WRITE,
		...
		NEXT_PUBLIC_NEWS_AND_ANNOUNCEMENTS: process.env.NEXT_PUBLIC_NEWS_AND_ANNOUNCEMENTS,
		...
		NEXT_PUBLIC_ENABLE_ENVIRONMENTAL_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_ENVIRONMENTAL_QUICKSEARCH,
		NEXT_PUBLIC_ENABLE_LOGIN: process.env.NEXT_PUBLIC_ENABLE_LOGIN,
		NEXT_PUBLIC_ENABLE_NEWS: process.env.NEXT_PUBLIC_ENABLE_NEWS,
