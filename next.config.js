...
module.exports = withPlugins([withTranspileModules], {
	...
	publicRuntimeConfig: {
		...
		NEXT_PUBLIC_ARRANGER_SEQUENCES_ADMIN_UI:
			process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_ADMIN_UI_URL,
		NEXT_PUBLIC_ARRANGER_SEQUENCES_API: process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_API_URL,
		NEXT_PUBLIC_ARRANGER_SEQUENCES_DOCUMENT_TYPE:
			process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_SEQUENCES_INDEX: process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_INDEX,
		NEXT_PUBLIC_ARRANGER_SEQUENCES_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_SEQUENCES_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_SEQUENCES_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_SEQUENCES_MAX_BUCKET_COUNTS || 1000,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_ADMIN_UI:
			process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_ADMIN_UI_URL,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_API: process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_API_URL,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_DOCUMENT_TYPE:
			process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_DOCUMENT_TYPE,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_INDEX: process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_INDEX,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_CARDINALITY_PRECISION_THRESHOLD:
			process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_CARDINALITY_PRECISION_THRESHOLD || 3000,
		NEXT_PUBLIC_ARRANGER_WASTEWATER_MANIFEST_COLUMNS:
			process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_MANIFEST_COLUMNS || '',
		NEXT_PUBLIC_ARRANGER_WASTEWATER_MAX_BUCKET_COUNTS:
			process.env.NEXT_PUBLIC_ARRANGER_WASTEWATER_MAX_BUCKET_COUNTS || 1000,
		...
		NEXT_PUBLIC_ENABLE_SEQUENCES_QUICKSEARCH: process.env.NEXT_PUBLIC_ENABLE_SEQUENCES_QUICKSEARCH,
		NEXT_PUBLIC_ENABLE_WASTEWATER_QUICKSEARCH:
			process.env.NEXT_PUBLIC_ENABLE_WASTEWATER_QUICKSEARCH,
